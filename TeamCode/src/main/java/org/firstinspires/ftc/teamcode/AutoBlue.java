...
@Autonomous(name = "AutonBlueSupers", group = "Autonomous")
public class AutoBlue extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        // --- FLIPPED FOR BLUE SIDE ---
        turnLeft(1.0, 500); // Flipped from turnRight
        ...
        strafeLeft(1, 750); // Flipped from strafeRight
        moveForward(1.0, 1000);
        moveBackward(1.0, 1000);
        strafeRight(1, 750); // Flipped from strafeLeft
        
        setTransferPower(1);
        sleep(500);
        strafeLeft(1, 500); // Flipped from strafeRight
        moveForward(1.0, 1000);
        stopRobot();
        sleep(500);
        moveBackward(1, 200);
        
        // Manual power blocks - assuming these are not turning but weight shift/pitch control
        leftFrontDrive.setPower(0.5);
        rightFrontDrive.setPower(0.5);
        ...
        moveBackward(1, 200);
        strafeRight(1, 1000); // Flipped from strafeLeft
        setTransferPower(1);
        sleep(500);
        strafeLeft(1, 1000); // Flipped from strafeRight
        ...
        setTransferPower(1);
        sleep(500);
        strafeLeft(1, 1500); // Flipped from strafeRight
        
        moveForward(1, 300);
        moveBackward(1, 500);
        strafeLeft(1, 300); // Flipped from strafeRight
